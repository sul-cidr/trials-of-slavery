/*
  The published `pagefind.js` is a concatenation of:
  * inlined `const pagefind_version = "x.x.x";`
  * pagefind/vendor/pagefind_web.x.x.x.js (built with `cd pagefind_web && ./local_build.sh)
  * pagefind/src/output/stubs/gz.js
  * pagefind/src/output/stubs/search.js


  Here the first two files are vendored in and imported here, and the last is inlined below
   with the following modifications:

  * the `Pagefind` class is exported
  * the `Pagefind` constructor takes an optional `options` object and passes it to
    `this.primary = new PagefindInstance({ ...opts, primary: true });`

  See https://github.com/CloudCannon/pagefind/issues/129
*/

import { wasm_bindgen } from "./web.js"; /* pagefind/vendor/pagefind_web.0.9.1.js */
import { gunzip } from "./gz.js"; /* pagefind/src/output/stubs/gz.js */

const pagefind_version = "0.9.1";

/* pagefind/src/output/stubs/search.js follows */
